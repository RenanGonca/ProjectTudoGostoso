...
import 'package:tudo_gostoso/screens/home/widget/details.dart';
import 'package:tudo_gostoso/screens/home/widget/list_elements.dart';
import 'package:tudo_gostoso/screens/home/widget/my_title.dart';
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tudo Gostoso", style: TextStyle(fontWeight: FontWeight.bold,
        ),
        ),
      ...
      body: SingleChildScrollView(
          ...
          children: [
            ...
            Details(recipe),
            MyTitle(title: "ingredientes", icon: FontAwesomeIcons.bookOpen,
            ),
            ListElements(title: "Massa", listOfElements: recipe.ingredientsPaste,
            ),
            ListElements(title: "Cobertura", listOfElements: recipe.ingredientsTopping,
            ),
            MyTitle(icon: FontAwesomeIcons.utensilSpoon, title: "Modo de Preparo"
            ),
            ListElements(title: "Massa", listOfElements: recipe.preparationModePaste,
            ),
            ListElements(title: "Cobertura", listOfElements: recipe.preparationModeTopping,
            ),
          ],
        ),
      ),
